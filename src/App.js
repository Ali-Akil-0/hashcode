          ...
          <div className="app__ProblemStart">
            ...
            <div className="app__ProblemStartText">
              <p className="app__ProblemStartTextPar">
                Work is so much more fun when we are part of a team! By
                combining our different skills, we can be more creative,
                efficient and productive. And more importantly, when working
                together we share... not only pizzas, but also knowledge. We can
                learn from each other, improve our own skills and gain
                experience.
              </p>
              <p className="app__ProblemStartTextPar">
            ...
            <div className="app__problemSummary">
              ...
              <div className="app__problemSummaryPar">
                <p className="app__ProblemStartTextPar">
                  You are given a list of contributors, who have already
                  mastered various skills, and a list of projects with different
                  skill requirements. Contributors can improve their skills by
            ...
            <div className="app__problemDescription">
              ...
              <div className="app__problemDescriptionContributors">
                ...
                <div className="app__problemDescriptionText">
                  <p className="app__ProblemStartTextPar">
                    There are N contributors. Each contributor has a name and
                    one or more skills at a specific level (0,1,2,...). Not
                    possessing a skill is equivalent to possessing a skill at
                    level 0.
                  </p>
                ...
                <div className="app__problemDescriptionText">
                  ...
                  <div className="app__projectsUl">
                    <ul className="outside">
                      <li>its name</li>
                      <li>
                        the duration of the project in days (how long it takes
                        to complete a project once it is started)
                      </li>
                      <li>the score awarded for completing the project</li>
                      <li>
                        the “best before” time in days – if the project last day
                        of work is strictly before the indicated day, it earns
                        the full score. If it’s late (that is, the project is
                        still worked on during or after its "best before day"),
                        it gets one point less for each day it is late, but no
                        less than zero points. See also the example in the
                    ...
                    <p className="app__ProblemStartTextPar">
                      Each project has one or more roles that need to be filled
                      by contributors. Each role requires one skill at a
                      specific level, and can be filled by a single contributor.
                      Each contributor can fill{" "}
                      <span className="app__textBold">at most one role</span> on
                      a single project.
                    </p>
                  </div>
              ...
              <div className="app__problemDescriptionProjects">
                ...
                <div className="app__problemDescriptionText">
                  <p className="app__ProblemStartTextPar">
                    A contributor can be assigned to a project for a specific
                    role (at most one role in a single project), if they either:
                  </p>
                  <div className="app__projectsUl">
                    <ul className="outside">
                      <li>
                      ...
                      <li>
                        ...
                        . In this case, the contributor will be mentored by
                        their colleague :)
                      </li>
                    </ul>
                    <p className="app__ProblemStartTextPar">
                    ...
                    <p className="app__ProblemStartTextPar">
                      ...
                      don’t know any C++, provided that somebody else on the
                      team{" "}
                  ...
                  <div className="app__problemExample">
                    ...
                    <p>
                      For the project WebServer above we could make the
                      following assignments:
                    </p>
                    <p>
                      Role 0 (requires Python level 3) is assigned to Anna
                      (Python level 3).
                    </p>
                    ...
                    <p>
                      Role 1 (requires HTML level 1) is assigned to Bob (C++
                      level 3).
                    </p>
                    <p className="app__projectsMoveRight">
                      <p>
                        <AiOutlineWarning className="app__warning" />
                        Bob has level 0 in HTML. Since his level is only one
                        below required, he can be assigned, but must be mentored
                        by another contributor who knows HTML at level 1 or
                        above.
                      </p>
                    </p>
                    <p>
              ...
              <div className="app__problemDescriptionAssignments">
                ...
                <div className="app__problemDescriptionText">
                  <p className="app__ProblemStartTextPar">
                    Each contributor can start working on day 0 and can be
                    working on at most one project at the same time. Once the
                    work on a project starts, its contributors will be working
                    on it the number of days equal to its duration and then
                    become available to work on other projects.
                  </p>
                  <div className="app__problemExample">
                    <p className="app__ProblemStartTextPar">
                      For example, if the project WebServer has duration of 7
                      days and starts on day 0, the contributors assigned to it
                      will be working on it during: day 0, day 1, day 2, day 3,
                      day 4, day 5 and day 6. On day 7 the project is already
                      completed. Contributors assigned to it can work on another
                      project on day 7.
                    </p>
                  </div>
                </div>
              ...
              <div className="app__problemDescriptionLearning">
                ...
                <div className="app__problemDescriptionText">
                  <p className="app__ProblemStartTextPar">
                    Completing a project is a learning opportunity, especially
                    for the contributors working on the edge of their existing
                    abilities! When each project is completed:
                  </p>
                  <ul className="outside">
                    <li>
                      contributors working in roles where the required skill
                      level was equal or higher than their current level improve
                      their skill level by one level
                    </li>
                    <li>other contributors keep their skill level</li>
                  </ul>
                  <p className="app__ProblemStartTextPar">
                    Note that{" "}
                    <span className="app__problemBold">mentoring</span> someone
                    doesn’t increase the level of the skill for the mentor.
                  </p>
                  <div className="app__problemExample">
                    <p className="app__ProblemStartTextPar app__examplePar">
                      For example:
                    ...
                    <ul className="outside">
                      ...
                      <li>
                        Maria improves neither the CSS skill (because Maria’s
                        CSS is already at a level higher than required) nor the
                        HTML skill (because her role required CSS, not HTML).
                      </li>
                    </ul>
                  </div>
                </div>
              ...
              <div className="app__problemDescriptionFileFormat">
                ...
                <div className="app__problemFileFormat">
                  <p className="app__ProblemStartTextPar">
                    Each input data set is provided in a plain text file. The
                    file contains only ASCII characters with lines ending with a
                    single '\n' character (also called “UNIX-style” line
                    endings). When multiple strings and numbers are given in one
                    line, they are separated by a single space between each two
                    elements.
                  </p>
                  <p className="app__ProblemStartTextPar">
                  ...
                  <ul className="outside">
                    <li>
                      ...
                      <ul className="secondOutside">
                        ...
                        <li>
                          an integer N (1≤ N ≤ 100) - the number of skills of
                          the contributor.
                        </li>
                      </ul>
                    </li>
                  ...
                  <p className="app__ProblemStartTextPar">
                    This is followed by P sections describing individual
                    projects. Each project is described by the following lines:
                  </p>
                  ...
                  <ul className="outside">
                    <li>
                      ...
                      <ul className="secondOutside">
                        ...
                        <li>
                          an integer Bi (1 ≤ Bi ≤ 105) – the “best before” day
                          for the project,
                        </li>
                        <li>
                  ...
                  <ul className="outside">
                    <li>
                      ...
                      <ul className="secondOutside">
                        <li>
                          a string Xk – the name of the skill (ASCII string of
                          at most 20 characters, all of which are lowercase or
                          uppercase English alphabet letters a-z and A-Z,
              ...
              <div className="app__problemDescriptionExample">
                ...
                <div className="app__problemExampleContainer">
                  ...
                  <div className="app__ExampleDescription">
                    ...
                    <p>
                      first contributor needs to have Python at level ≥ 3 (2
                      with mentoring)
                    </p>
                    <p>
              ...
              <div className="app__problemDescriptionExample">
                ...
                <p className="app__ProblemStartTextPar">
                  The first line should contain the integer E (0≤E≤P) – the
                ...
                <ul className="putside">
                  ...
                  <li>
                    ...
                    spaces and listed in the same order as the roles appear in
                    the input file.
                  </li>
                </ul>
              </div>
              <div className="app__problemDescriptionExample">
                ...
                <div className="app__problemExampleContainer">
                  ...
                  <div className="app__ExampleDescription">
                    ...
                    <p>
                      contMaria → first role, Bob → second roleributor Maria
                    </p>
                  </div>
                </div>
              </div>
              <div className="app__problemDescriptionExample">
                ...
                <p className="app__ProblemStartTextPar">
                  Each contributor can only work on one project at a time. If
                  one contributor is assigned to multiple projects, the
                  contributor will work on them in the same order as they appear
                  in the submission file. Each project starts immediately on the
                  first day on which all the assigned contributors are
                  available.
                </p>
                <img
                  src={schedule}
                ...
                <p className="app__ProblemStartTextPar">
                  ...
                  points for any delay. If a project is completed after its
                  “best before” time, it gets one point less for each day it is
                  late (but no less than zero points). Note that even if a
                  project scores zero points, the assigned contributors will
                  work on it (and may improve their skills thanks to it).
                </p>
                <p className="app__ProblemStartTextPar">
                  The total score is the sum of scores for all correctly
                  completed projects.
                </p>
                <div className="app__textContainer">
                  <p>
                    The <span>example</span> submission results in this
                    timeline:
                  </p>
                  <p>
                    Day 0 to day 6: Bob and Anna are working on project
                    WebServer (they both have the skills required).
                  </p>
                  <ul className="outside">
                    <li>
                    ...
                    <li>
                      Bob doesn't level up because his HTML skill (level 5) is
                      of a higher level than required for the project (level 3).
                    </li>
                  </ul>
                  <p>
                    Project WebServer's last day of work is day 6, so it
                    completes strictly before its "best before" day 7 and
                    receives the full score: 10 points.
                  </p>
                  <p>
                  ...
                  <p>
                    ...
                    strictly before day 12), while its "best before" day was 5.
                    It is late by (12−5=) 7 days and receives a score of:
                    (10−7=) 3 points.
                  </p>
                  <p>
                  ...
                  <ul className="outside">
                    <li>
                      As of project completion, Maria levels up in Python: level
                      3 → 4;
                    </li>
                    <li>
                  ...
                  <p>
                    Project WebChat's last day of work is day 16, while the
                    "best before" day is 20, so it receives the full score: 20
                    points.
                  </p>
                  <p>
                    In the end, projects Webserver (10 points), Logging (3
                    points) and WebChat (20 points) are completed, resulting in
                    a total score of 33 points.
                  </p>
                </div>
                <p>
                  Note that there are multiple data sets representing separate
                  instances of the problem. The final score for your team will
                  be the sum of your best scores for the individual data sets.
                </p>
              </div>
            </div>
          </div>
